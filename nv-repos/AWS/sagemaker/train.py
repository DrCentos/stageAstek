...
def train():
    ...
    joblib.dump(sc, '../opt/ml/scaler.bin') #save in local should be ../opt/ml//mymodel.joblib

    joblib.dump(regressor, '../opt/ml/mymodel') #save in local should be ../opt/ml//model/mymodel.joblib
